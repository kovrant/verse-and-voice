...
(41, 'prayer', 'الدُّعَاءُ هُوَ الْعِبَادَةُ', 'Supplication (Dua) is the essence of worship.', 'دعا ہی اصل عبادت ہے۔', 'An-Nu`man ibn Bashir (RA)', 'Jami` at-Tirmidhi 2969', 'Make a sweet Dua to Allah whenever you want something or before you sleep!', 41),
(42, 'manners', 'مَنْ لَا يَشْكُرِ النَّاسَ لَا يَشْكُرِ اللَّهَ', 'Whoever does not thank people does not thank Allah.', 'جو لوگوں کا شکر ادا نہیں کرتا، وہ اللہ کا بھی شکر ادا نہیں کرتا۔', 'Abu Hurairah (RA)', 'Jami` at-Tirmidhi 1954', 'Always say "Thank You" and "JazakAllah Khair" to parents, teachers, and friends who help you.', 42),
(43, 'manners', 'الْأَنَاةُ مِنَ اللَّهِ وَالْعَجَلَةُ مِنَ الشَّيْطَانِ', 'Deliberation and calm patience is from Allah, while haste is from Shaytan.', 'اطمینان اور بردباری اللہ کی طرف سے ہے اور جلد بازی شیطان کی طرف سے ہے۔', 'Anas ibn Malik (RA)', 'Jami` at-Tirmidhi 2012', 'Take your time, be patient when doing your work, and do not rush or push others.', 43),
(44, 'family', 'لَا يَدْخُلُ الْجَنَّةَ قَاطِعُ رَحِمٍ', 'One who severs family ties will not enter Paradise.', 'رشتہ داری توڑنے والا جنت میں داخل نہیں ہوگا۔', 'Jubayr ibn Mut`im (RA)', 'Sahih al-Bukhari 5984', 'Stay close with your cousins, uncles, aunts, and grandparents, and call them often!', 44),
(45, 'kindness', 'خَيْرُ الْأَصْحَابِ عِنْدَ اللَّهِ خَيْرُهُمْ لِصَاحِبِهِ', 'The best of companions in the sight of Allah is the one who is best to his companion.', 'اللہ کے نزدیک بہترین ساتھی وہ ہے جو اپنے ساتھی کے حق میں سب سے بہتر ہو۔', 'Abdullah ibn Amr (RA)', 'Jami` at-Tirmidhi 1944', 'Be a loyal, encouraging, and kind best friend who helps others do good.', 45),
(46, 'truthfulness', 'أَعْطُوا الْأَجِيرَ أَجْرَهُ قَبْلَ أَنْ يَجِفَّ عَرَقُهُ', 'Give the worker his wages before his sweat dries.', 'مزدور کو اس کی مزدوری اس کا پسینہ خشک ہونے سے پہلے ادا کرو۔', 'Abdullah ibn Umar (RA)', 'Sunan Ibn Majah 2443', 'Always be fair, respect helpers and workers, and thank them promptly.', 46),
(47, 'knowledge', 'الْمَرْءُ مَعَ مَنْ أَحَبَّ', 'A person will be with those whom he loves on the Day of Judgment.', 'انسان قیامت کے دن اسی کے ساتھ ہوگا جس سے وہ محبت کرتا ہے۔', 'Abdullah ibn Mas`ud (RA)', 'Sahih al-Bukhari 6168', 'Love Prophet Muhammad (ﷺ) and righteous people so you can be with them in Jannah!', 47),
(48, 'prayer', 'تَسَحَّرُوا فَإِنَّ فِي السَّحُورِ بَرَكَةً', 'Eat Suhur (pre-dawn meal), for indeed there is blessing in Suhur.', 'سحری کھایا کرو کیونکہ سحری میں برکت ہے۔', 'Anas ibn Malik (RA)', 'Sahih al-Bukhari 1923', 'Wake up early for Suhur when fasting, and start your day with healthy food and Bismillah.', 48),
(49, 'manners', 'اتَّقِ اللَّهَ حَيْثُمَا كُنْتَ', 'Be mindful and conscious of Allah wherever you are.', 'تم جہاں کہیں بھی ہو اللہ کا تقویٰ اختیار کرو۔', 'Abu Dharr (RA)', 'Jami` at-Tirmidhi 1987', 'Remember that Allah is always watching you with love, so do the right thing even when alone.', 49),
(50, 'knowledge', 'مَنْ صَلَّى عَلَيَّ صَلَاةً صَلَّى اللَّهُ عَلَيْهِ بِهَا عَشْرًا', 'Whoever sends blessings upon me once, Allah sends blessings upon him ten times.', 'جو مجھ پر ایک بار درود بھیجے گا، اللہ اس پر دس رحمتیں نازل فرمائے گا۔', 'Abu Hurairah (RA)', 'Sahih Muslim 408', 'Say "Sallallahu Alayhi Wasallam" (ﷺ) every day to receive 10 special blessings from Allah!', 50)
